...
- **A7 — SDSL-V validation M0:** begin semantic validation over the new typed AST before HLSL emission work.
- **A8 — Actuation contracts:** define typed actuation boundaries and actuator-owned side-effect contracts.
