...
- **A8 — HLSL emission M0 over new AST:** begin emission contracts after parser/validation M0, without adding `.sdslvtest` or CPU shader evaluation yet.
