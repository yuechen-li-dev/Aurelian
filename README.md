...
- It does not contain a visual renderer, windowing, triangle, Machina integration, WyrmCoil integration, or remaining unconverted Stri-V salvage projects; the only renderer implementation is the headless null backend for command-plan tests.
