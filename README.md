...
- The home of `Aurelian.Shaders`, an Aurelian-owned shader module with a new WyrmCoil-inspired SDSL-V AST contract, token-driven parser/validator/HLSL emitter paths, a deterministic SDSL-V artifact manifest M0, an explicit compatibility matrix, and a temporarily preserved carried-over legacy pipeline.
